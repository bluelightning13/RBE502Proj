	...
	%trajectory = cscvn(points)
        ...
        for i = 1 : 100
            ...
            actual(7) = (thrust / m)*(cos(cos(actual(12))*sin(cos(actual(11))*cos(actual(10))+sin(actual(12))*sin(actual(10)));
            actual(8) = (thrust / m)*(sin(actual(12))*sin(cos(actual(11))*cos(actual(10))-cos(actual(12))*sin(actual(10)));
