...
% mcontrol is cubic 
function [updated_actual,updated_phi_d,updated_theta_d,updated_psi_d] = controller(desired,actual,phi_d,theta_d,psi_d)
...
alpha_phi = (Kphi_p * (phi - actual(10)) + Kphi_d * (phi_d));
alpha_theta = (Ktheta_p * (theta - actual(11)) + Ktheta_d * (theta_d));
alpha_psi = (Kpsi_p * (psi - actual(12)) + Kpsi_d * (psi_d));
